        ...
        builder: (context, state) {
          return (mapType == 'google_map')
              ...
              : fm.FlutterMap(
                  ...
                  children: [
                    fm.TileLayer(
                      urlTemplate: (userData!.osmMapSettings.enableMapbox ==
                                  true &&
                              userData!
                                  .osmMapSettings.mapboxPublicKey.isNotEmpty)
                          ? 'https://api.mapbox.com/styles/v1/mapbox/streets-v12/tiles/256/{z}/{x}/{y}?access_token=${userData!.osmMapSettings.mapboxPublicKey}'
                          : (userData!.osmMapSettings.enableThunderforest ==
                                      true &&
                                  userData!.osmMapSettings.thunderforestApiKey
                                      .isNotEmpty)
                              ? 'https://tile.thunderforest.com/cycle/{z}/{x}/{y}.png?apikey=${userData!.osmMapSettings.thunderforestApiKey}'
                              : (userData!.osmMapSettings.enableStadia ==
                                          true &&
                                      userData!.osmMapSettings.stadiaApiKey
                                          .isNotEmpty)
