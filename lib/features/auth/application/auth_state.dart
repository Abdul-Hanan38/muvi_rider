...
final class ValidateMobileSuccessState extends AuthState {}

final class ValidateMobileFailureState extends AuthState {
  final String message;
  ValidateMobileFailureState({required this.message});
}
