            ...
            children: [
              ...
              if (userData != null &&
                ...
                DraggableScrollableSheet(
                  initialChildSize: (homeBloc.rideList.isNotEmpty) ? 0.5 : 0.4,
                  minChildSize: (homeBloc.rideList.isNotEmpty) ? 0.5 : 0.4,
                  maxChildSize: 1.0,
              ...
              if (userData != null &&
                  ...
                  homeBloc.showGetDropAddress == false &&
                  userData!.active &&
                  homeBloc.bottomSize < size.height * 0.6)
                AnimatedPositioned(
                  right: 0,
                  top: homeBloc.bidRideTop! - size.width * 0.2,
              ...
              children: [
                ...
                if (snapshot.connectionState == ConnectionState.waiting)
                  ...
                  Container(
                    ...
                    child: MyText(
                      text: AppLocalizations.of(context)!.failedToLoadRidesText,
                  ...
                  Container(
                    ...
                    child: MyText(
                      text: AppLocalizations.of(context)!.noAcceptedRidesText,
                      textStyle: Theme.of(context).textTheme.bodySmall,
                    ),
                  )
                else ...[
...
class _FlutterMapWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context1) {
    ...
    return fm.FlutterMap(
      ...
      children: [
        fm.TileLayer(
          urlTemplate: (userData!.osmMapSettings.enableMapbox == true &&
                  userData!.osmMapSettings.mapboxPublicKey.isNotEmpty)
              ? 'https://api.mapbox.com/styles/v1/mapbox/streets-v12/tiles/256/{z}/{x}/{y}?access_token=${userData!.osmMapSettings.mapboxPublicKey}'
              : (userData!.osmMapSettings.enableThunderforest == true &&
                      userData!.osmMapSettings.thunderforestApiKey.isNotEmpty)
                  ? 'https://tile.thunderforest.com/cycle/{z}/{x}/{y}.png?apikey=${userData!.osmMapSettings.thunderforestApiKey}'
                  : (userData!.osmMapSettings.enableStadia == true &&
                          userData!.osmMapSettings.stadiaApiKey.isNotEmpty)
                      ? 'https://tiles.stadiamaps.com/tiles/alidade_smooth/{z}/{x}/{y}.png?api_key=${userData!.osmMapSettings.stadiaApiKey}'
                      : 'https://tile.openstreetmap.org/{z}/{x}/{y}.png',
          userAgentPackageName: 'com.muviperu.driverapp',
