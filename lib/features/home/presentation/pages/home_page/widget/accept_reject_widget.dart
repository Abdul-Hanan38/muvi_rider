                      ...
                      children: [
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    MyText(
                                      text: userData!
                                          .metaRequest!.convertedTripStartTime,
                                      textStyle: TextStyle(
                                        fontSize: 15,
                          ...
                          buildPremiumCard(
                            child: Row(
                              ...
                              children: [
                                MyText(
                                  text:
                                      userData!.metaRequest!.rentalPackageName,
                                  textStyle: TextStyle(
                                    fontSize: 15,
                                    fontWeight: FontWeight.bold,
                                    color: isDark
                            ...
                            children: [
                              Row(
                                children: [
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            if (userData!.metaRequest!
                                                    .userCompletedRideCount
                                                    .toString() !=
                                                '0') ...[
                                  ...
                                  if (userData!
                                          .metaRequest!.showRequestEtaAmount ==
                                      true)
                                    Column(
                                      crossAxisAlignment:
                        ...
                        buildPremiumCard(
                          child: Builder(builder: (context) {
                            ...
                            if (userData!.metaRequest!.pickPocInstruction !=
                                    null &&
                                userData!.metaRequest!.pickPocInstruction
                                    .toString()
                                    .trim()
                                    .isNotEmpty) {
                              pickupInstruction = userData!
                            ...
                            if (userData!
                              ...
                              for (var i = 0;
                                ...
                                addressItems.add({
                                  'title': 'Stop ${i + 1}',
                                  'address': userData!
                                      .metaRequest!.requestStops[i]['address'],
                                  'isPickup': false,
                                  'instruction': '',
                                  'color': isDark
                                      ? const Color(0xFF9CA3AF)
                            ...
                            return Column(
                              children:
                                  List.generate(addressItems.length, (index) {
                        ...
                        if (userData!.metaRequest!.transportType ==
                                'delivery' &&
                              ...
                              Expanded(
                                child: MyText(
                                  text: AppLocalizations.of(context)!
                                      ...
                                      .toString()
                                      .replaceAll('1111',
                                          userData!.acceptDuration.toString()),
                                  textStyle: const TextStyle(
                                    fontSize: 13,
                                    fontWeight: FontWeight.w500,
                                    color: AppColors.red,
