...
class _HomePageState extends State<HomePage>
  ...
  bool _promoCheckedOnStart = false;
  @override
  void initState() {
      ...
      child: BlocListener<HomeBloc, HomeState>(
        listener: (context, state) async {
          ...
          if (state is HomeDataLoadingStartState) {
            ...
            // Fire CheckPromotionEvent once after userData is loaded on app start
            if (!_promoCheckedOnStart) {
              _promoCheckedOnStart = true;
              homeBloc.add(CheckPromotionEvent());
            }
          } else if (state is ShowPromoPopupState) {
            if (userData != null &&
                (widget.args?.from == '0' || homeBloc.choosenMenu == 0) &&
            ...
            showDialog(
              ...
              builder: (cc) {
                return CustomSingleButtonDialoge(
                  title: AppLocalizations.of(context)!.homeAlertText,
