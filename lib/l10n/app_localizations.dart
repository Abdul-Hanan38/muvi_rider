...
abstract class AppLocalizations {
  ...
  /// No description provided for @totalRunning.
  ///
  /// In en, this message translates to:
  /// **'Total Running'**
  String get totalRunning;
  ...
  /// No description provided for @blockedCabs.
  ///
  /// In en, this message translates to:
  /// **'Blocked Cabs'**
  String get blockedCabs;

  /// No description provided for @reportsLableText.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @manageYourDrivers.
  ///
  /// In en, this message translates to:
  /// **'Manage your drivers'**
  String get manageYourDrivers;

  /// No description provided for @addDriverDetailsText.
  ///
  /// In en, this message translates to:
  /// **'Enter driver details to add'**
  String get addDriverDetailsText;

  /// No description provided for @createAndViewSupportRequest.
  ///
  /// In en, this message translates to:
  /// **'Create and view support requests'**
  String get createAndViewSupportRequest;

  /// No description provided for @directMessageWithOurSupportTeam.
  ///
  /// In en, this message translates to:
  /// **'Direct message with our support team'**
  String get directMessageWithOurSupportTeam;

  /// No description provided for @historyPageLableText.
  ///
  /// In en, this message translates to:
  /// **'View your past, upcoming and cancelled rides'**
  ...
  /// No description provided for @tripSummaryLableText.
  ///
  /// In en, this message translates to:
  /// **'View summary and fare breakdown'**
  String get tripSummaryLableText;

  /// No description provided for @historyReturnTimeValue.
  ///
  /// In en, this message translates to:
  /// **'Return: *****'**
  String get historyReturnTimeValue;

  /// No description provided for @historyPickupCaps.
  ///
  /// In en, this message translates to:
  /// **'PICKUP'**
  String get historyPickupCaps;

  /// No description provided for @historyDropCaps.
  ///
  /// In en, this message translates to:
  /// **'DROP'**
  String get historyDropCaps;

  /// No description provided for @noCompletedRidesText.
  ///
  /// In en, this message translates to:
  /// **'No Completed Rides'**
  String get noCompletedRidesText;

  /// No description provided for @noCompletedRidesTextSubTitle.
  ///
  /// In en, this message translates to:
  /// **'You don\'t have any completed ride history right now.'**
  String get noCompletedRidesTextSubTitle;

  /// No description provided for @noCompletedRidesTextTipText.
  ///
  /// In en, this message translates to:
  /// **'Your completed rides will appear here once you finish them.'**
  String get noCompletedRidesTextTipText;

  /// No description provided for @noUpcomingRidesText.
  ///
  /// In en, this message translates to:
  /// **'No Upcoming Rides'**
  String get noUpcomingRidesText;

  /// No description provided for @noUpcomingRidesTextSubTitle.
  ///
  /// In en, this message translates to:
  /// **'You don\'t have any upcoming ride bookings right now.'**
  String get noUpcomingRidesTextSubTitle;

  /// No description provided for @noUpcomingRidesTextTipText.
  ///
  /// In en, this message translates to:
  /// **'Your upcoming rides will appear here once you create them.'**
  String get noUpcomingRidesTextTipText;

  /// No description provided for @noCancelledRidesText.
  ///
  /// In en, this message translates to:
  /// **'No Cancelled Rides'**
  String get noCancelledRidesText;

  /// No description provided for @noCancelledRidesTextSubTitle.
  ///
  /// In en, this message translates to:
  /// **'You don\'t have any cancelled ride history right now.'**
  String get noCancelledRidesTextSubTitle;

  /// No description provided for @noCancelledRidesTextTipText.
  ///
  /// In en, this message translates to:
  /// **'Your cancelled rides will appear here if you or your customers cancel.'**
  String get noCancelledRidesTextTipText;

  /// No description provided for @historyTipText.
  ///
  /// In en, this message translates to:
  /// **'Tip'**
  String get historyTipText;

  /// No description provided for @keepGoingText.
  ///
  /// In en, this message translates to:
  /// **'Keep going!'**
  String get keepGoingText;

  /// No description provided for @incentiveCompleteMoreRidesText.
  ///
  /// In en, this message translates to:
  /// **'Complete more rides to unlock exciting incentives.'**
  String get incentiveCompleteMoreRidesText;

  /// No description provided for @topEarnersText.
  ///
  /// In en, this message translates to:
  /// **'Top Earners'**
  String get topEarnersText;

  /// No description provided for @topTripsText.
  ///
  /// In en, this message translates to:
  /// **'Top Trips'**
  String get topTripsText;

  /// No description provided for @keepItUpText.
  ///
  /// In en, this message translates to:
  /// **'Keep it up!'**
  String get keepItUpText;

  /// No description provided for @leaderboardCompleteMoreText.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @levelUpPageRewardsText.
  ///
  /// In en, this message translates to:
  /// **'Keep driving to unlock exciting rewards!'**
  String get levelUpPageRewardsText;

  /// No description provided for @yourProgressText.
  ///
  /// In en, this message translates to:
  /// **'Your Progress'**
  String get yourProgressText;

  /// No description provided for @reachedMaxLevelText.
  ///
  /// In en, this message translates to:
  /// **'You have reached the maximum level!'**
  String get reachedMaxLevelText;

  /// No description provided for @completeMoreRideToReachText.
  ///
  /// In en, this message translates to:
  /// **'Complete 111 more rides to reach 222 333'**
  String get completeMoreRideToReachText;

  /// No description provided for @ridesCompletedCountText.
  ///
  /// In en, this message translates to:
  /// **'111 rides completed'**
  String get ridesCompletedCountText;

  /// No description provided for @levelBenefitsText.
  ///
  /// In en, this message translates to:
  /// **'Level Benefits'**
  String get levelBenefitsText;

  /// No description provided for @prioritySupportText.
  ///
  /// In en, this message translates to:
  /// **'Priority Support'**
  String get prioritySupportText;

  /// No description provided for @getFasterSupportHelpText.
  ///
  /// In en, this message translates to:
  /// **'Get faster support when you need help.'**
  String get getFasterSupportHelpText;

  /// No description provided for @bonusEarningsText.
  ///
  /// In en, this message translates to:
  /// **'Bonus Earnings'**
  String get bonusEarningsText;

  /// No description provided for @earnExtraEligibleRideText.
  ///
  /// In en, this message translates to:
  /// **'Earn extra on every eligible ride.'**
  String get earnExtraEligibleRideText;

  /// No description provided for @exclusiveRewardsText.
  ///
  /// In en, this message translates to:
  /// **'Exclusive Rewards'**
  String get exclusiveRewardsText;

  /// No description provided for @accessSpecialrewardsAndOffersText.
  ///
  /// In en, this message translates to:
  /// **'Access special rewards and offers.'**
  String get accessSpecialrewardsAndOffersText;

  /// No description provided for @allLevelsText.
  ///
  /// In en, this message translates to:
  /// **'All Levels'**
  String get allLevelsText;

  /// No description provided for @noLevelsFoundText.
  ///
  /// In en, this message translates to:
  /// **'No levels found.'**
  String get noLevelsFoundText;

  /// No description provided for @noNotificationAvailableText.
  ///
  /// In en, this message translates to:
  /// **'No Notification Available'**
  String get noNotificationAvailableText;

  /// No description provided for @youAllcaughtUpText.
  ///
  /// In en, this message translates to:
  /// **'You\'re all caught up!'**
  String get youAllcaughtUpText;

  /// No description provided for @noMoreNotificationsShowText.
  ///
  /// In en, this message translates to:
  /// **'No more notifications to show.'**
  String get noMoreNotificationsShowText;

  /// No description provided for @manageYourPersonalDetailsText.
  ///
  /// In en, this message translates to:
  /// **'Manage your personal details'**
  String get manageYourPersonalDetailsText;

  /// No description provided for @addProfilePhotoSubText.
  ///
  /// In en, this message translates to:
  /// **'So users can recognize you easily'**
  String get addProfilePhotoSubText;

  /// No description provided for @referralContentUnavailableText.
  ///
  /// In en, this message translates to:
  /// **'Referral content is unavailable. Please try again later.'**
  String get referralContentUnavailableText;

  /// No description provided for @moreFriendsMoreRewards.
  ///
  /// In en, this message translates to:
  /// **'More friends, more rewards!'**
  String get moreFriendsMoreRewards;

  /// No description provided for @rewardsHowItWorksPointOne.
  ///
  /// In en, this message translates to:
  /// **'1. Earn points'**
  String get rewardsHowItWorksPointOne;

  /// No description provided for @rewardsHowItWorksPointOneText.
  ///
  /// In en, this message translates to:
  /// **'Complete rides and activities to earn points.'**
  String get rewardsHowItWorksPointOneText;

  /// No description provided for @rewardsHowItWorksPointTwo.
  ///
  /// In en, this message translates to:
  /// **'2. Accumulate points'**
  String get rewardsHowItWorksPointTwo;

  /// No description provided for @rewardsHowItWorksPointTwoText.
  ///
  /// In en, this message translates to:
  /// **'Collect points in your account and convert to money.'**
  String get rewardsHowItWorksPointTwoText;

  /// No description provided for @rewardsHowItWorksPointThree.
  ///
  /// In en, this message translates to:
  /// **'3. Redeem rewards'**
  String get rewardsHowItWorksPointThree;

  /// No description provided for @rewardsHowItWorksPointThreeText.
  ///
  /// In en, this message translates to:
  /// **'Use your converted points for discounts or cashback.'**
  String get rewardsHowItWorksPointThreeText;

  /// No description provided for @morePointsMoreRewardsText.
  ///
  /// In en, this message translates to:
  /// **'More points, more rewards!'**
  String get morePointsMoreRewardsText;

  /// No description provided for @keepRidingAndKeepEarningText.
  ///
  /// In en, this message translates to:
  /// **'Keep riding and keep earning.'**
  String get keepRidingAndKeepEarningText;

  /// No description provided for @faqSubText.
  ///
  /// In en, this message translates to:
  /// **'Frequently Asked Questions'**
  String get faqSubText;

  /// No description provided for @chooseMapSubText.
  ///
  /// In en, this message translates to:
  /// **'Choose your preferred map style'**
  String get chooseMapSubText;

  /// No description provided for @chooseMapTipText.
  ///
  /// In en, this message translates to:
  /// **'Your location and map preferences are only visible to you.'**
  String get chooseMapTipText;

  /// No description provided for @themeLableText.
  ///
  /// In en, this message translates to:
  /// **'Choose between light and dark theme'**
  String get themeLableText;

  /// No description provided for @mapLableText.
  ///
  /// In en, this message translates to:
  /// **'Select your preferred map style'**
  String get mapLableText;

  /// No description provided for @faqLableText.
  ///
  /// In en, this message translates to:
  /// **'Frequently asked questions'**
  String get faqLableText;

  /// No description provided for @privacyPolicyLableText.
  ///
  /// In en, this message translates to:
  /// **'View terms and privacy policy'**
  String get privacyPolicyLableText;

  /// No description provided for @deleteAccountLableText.
  ///
  /// In en, this message translates to:
  /// **'Permanently remove your account'**
  String get deleteAccountLableText;

  /// No description provided for @sosNoContactsAdded.
  ///
  /// In en, this message translates to:
  /// **'No contacts added'**
  String get sosNoContactsAdded;

  /// No description provided for @sosSubTextAdded.
  ///
  /// In en, this message translates to:
  /// **'For your security, add at least one person that we can call in an emergency.'**
  String get sosSubTextAdded;

  /// No description provided for @sosEmergenctContactsText.
  ///
  /// In en, this message translates to:
  /// **'Emergency Contacts'**
  String get sosEmergenctContactsText;

  /// No description provided for @sosEmergenctSubText.
  ///
  /// In en, this message translates to:
  /// **'People we can call in an emergency'**
  String get sosEmergenctSubText;

  /// No description provided for @sosContactsText.
  ///
  /// In en, this message translates to:
  /// **'Contacts'**
  String get sosContactsText;

  /// No description provided for @sosContactText.
  ///
  /// In en, this message translates to:
  /// **'Contact'**
  String get sosContactText;

  /// No description provided for @sosAddFromContacts.
  ///
  /// In en, this message translates to:
  /// **'Add from contacts'**
  String get sosAddFromContacts;

  /// No description provided for @sosInformationSecureText.
  ///
  /// In en, this message translates to:
  /// **'Your information is kept secure'**
  String get sosInformationSecureText;

  /// No description provided for @sosFillContactDetailsBelow.
  ///
  /// In en, this message translates to:
  /// **'Fill in the contact details below'**
  String get sosFillContactDetailsBelow;

  /// No description provided for @sosContactDetailsPrivateAndSecure.
  ///
  /// In en, this message translates to:
  /// **'Your contact\'s information is kept private and secure'**
  String get sosContactDetailsPrivateAndSecure;

  /// No description provided for @subscriptionChoosePlanText.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @createTicketReturnText.
  ///
  /// In en, this message translates to:
  /// **'Raise a request and our team will get back to you.'**
  String get createTicketReturnText;

  /// No description provided for @createTicketFileDragDropText.
  ///
  /// In en, this message translates to:
  /// **'Drag & drop files here or'**
  String get createTicketFileDragDropText;

  /// No description provided for @createTicketBrowseText.
  ///
  /// In en, this message translates to:
  /// **'browse'**
  String get createTicketBrowseText;

  /// No description provided for @createTicketMaxFilesUploadText.
  ///
  /// In en, this message translates to:
  /// **'Max 8 files • png, jpg, jpeg, pdf, doc'**
  String get createTicketMaxFilesUploadText;

  /// No description provided for @createTicketFilesUploadedText.
  ///
  /// In en, this message translates to:
  /// **'111 files uploaded'**
  String get createTicketFilesUploadedText;

  /// No description provided for @createTickedClearAllText.
  ///
  /// In en, this message translates to:
  /// **'Clear All'**
  String get createTickedClearAllText;

  /// No description provided for @vehicleDetailsPageSubText.
  ///
  /// In en, this message translates to:
  /// **'View your vehicle details'**
  String get vehicleDetailsPageSubText;

  /// No description provided for @vehicleDetailsSearchDriversText.
  ///
  /// In en, this message translates to:
  /// **'Search driver by name or phone'**
  String get vehicleDetailsSearchDriversText;

  /// No description provided for @vehicleDetailsNoDrivesFoundText.
  ///
  /// In en, this message translates to:
  /// **'No drivers found'**
  String get vehicleDetailsNoDrivesFoundText;

  /// No description provided for @walletYourTranslationAreSafeText.
  ///
  /// In en, this message translates to:
  /// **'Your transactions are safe and secure'**
  String get walletYourTranslationAreSafeText;

  /// No description provided for @withdrawalYourDetailsAreSecurelyText.
  ///
  /// In en, this message translates to:
  /// **'Your details are encrypted and stored securely'**
  String get withdrawalYourDetailsAreSecurelyText;

  /// No description provided for @withdrawalAccountInformationText.
  ///
  /// In en, this message translates to:
  /// **'Account Information'**
  String get withdrawalAccountInformationText;

  /// No description provided for @withdrawalIncorrectBankDetailsText.
  ///
  /// In en, this message translates to:
  /// **'Make sure all details are accurate. Incorrect bank information may delay your withdrawals.'**
  String get withdrawalIncorrectBankDetailsText;

  /// No description provided for @withdrawalDataSafeText.
  ///
  /// In en, this message translates to:
  /// **'256-bit SSL encrypted · Your data is safe'**
  String get withdrawalDataSafeText;

  /// No description provided for @withdrawalsLinkBankAccountText.
  ///
  /// In en, this message translates to:
  /// **'Secure withdrawals to your linked bank account'**
  String get withdrawalsLinkBankAccountText;

  /// No description provided for @withdrawalTransactionsSecureText.
  ///
  /// In en, this message translates to:
  /// **'We ensure your transactions are safe and secure.'**
  String get withdrawalTransactionsSecureText;

  /// No description provided for @withdrawalPaymentInforText.
  ///
  /// In en, this message translates to:
  /// **'Your payment information is secure and encrypted'**
  String get withdrawalPaymentInforText;

  /// No description provided for @enterAmountAddText.
  ///
  /// In en, this message translates to:
  /// **'Enter amount to add'**
  String get enterAmountAddText;

  /// No description provided for @yourSavedCardsText.
  ///
  /// In en, this message translates to:
  /// **'Your Saved Cards'**
  String get yourSavedCardsText;

  /// No description provided for @saveCardExpiresText.
  ///
  /// In en, this message translates to:
  /// **'Expires 111'**
  String get saveCardExpiresText;

  /// No description provided for @noSaveCardsText.
  ///
  /// In en, this message translates to:
  /// **'No saved cards yet'**
  String get noSaveCardsText;

  /// No description provided for @saveCardMAnagePaymentsSecurelyText.
  ///
  /// In en, this message translates to:
  /// **'Add your first card to manage payments easily and securely.'**
  String get saveCardMAnagePaymentsSecurelyText;

  /// No description provided for @saveCardInforSecure.
  ///
  /// In en, this message translates to:
  /// **'Your card information is secure'**
  String get saveCardInforSecure;

  /// No description provided for @saveCardEncryptionText.
  ///
  /// In en, this message translates to:
  /// **'We use industry-standard encryption to keep your card details safe.'**
  String get saveCardEncryptionText;

  /// No description provided for @choosePaymentMethodSubText.
  ///
  /// In en, this message translates to:
  /// **'Select your preferred payment method to add money to your wallet'**
  String get choosePaymentMethodSubText;

  /// No description provided for @yourPaymentInfoSecureText.
  ///
  /// In en, this message translates to:
  /// **'Your payment information is secure and encrypted'**
  String get yourPaymentInfoSecureText;

  /// No description provided for @recipientTypeText.
  ///
  /// In en, this message translates to:
  /// **'Recipient Type'**
  String get recipientTypeText;
  ...
  /// No description provided for @transferSecureAndEncryptedText.
  ///
  /// In en, this message translates to:
  /// **'Your transfer is secure and encrypted'**
  String get transferSecureAndEncryptedText;

  /// No description provided for @withdrawalMoneySubText.
  ///
  /// In en, this message translates to:
  /// **'Enter the amount you want to withdraw'**
  String get withdrawalMoneySubText;

  /// No description provided for @quickSelectText.
  ///
  /// In en, this message translates to:
  /// **'Quick Select'**
  String get quickSelectText;

  /// No description provided for @withdrawalProcessedLinkedBankText.
  ///
  /// In en, this message translates to:
  /// **'Your withdrawal will be processed to your linked bank account.'**
  String get withdrawalProcessedLinkedBankText;

  /// No description provided for @secureEncrypedTransactionText.
  ///
  /// In en, this message translates to:
  /// **'Secure and encrypted transactions'**
  String get secureEncrypedTransactionText;

  /// No description provided for @profileSettingsLableText.
  ///
  /// In en, this message translates to:
  /// **'Manage your profile and settings'**
  String get profileSettingsLableText;

  /// No description provided for @myVehiclesLableText.
  ///
  /// In en, this message translates to:
  /// **'View and manage your vehicle details'**
  String get myVehiclesLableText;

  /// No description provided for @manageFleetLableText.
  ///
  /// In en, this message translates to:
  /// **'Manage fleets and vehicles'**
  String get manageFleetLableText;

  /// No description provided for @documentLableText.
  ///
  /// In en, this message translates to:
  /// **'Manage your documents'**
  String get documentLableText;

  /// No description provided for @walletLableText.
  ///
  /// In en, this message translates to:
  /// **'View balance and transactions'**
  String get walletLableText;

  /// No description provided for @fleetDriverLableText.
  ///
  /// In en, this message translates to:
  /// **'Manage drivers in your fleet'**
  String get fleetDriverLableText;

  /// No description provided for @dashboardLableText.
  ///
  /// In en, this message translates to:
  /// **'View fleet earnings and performance dashboard'**
  String get dashboardLableText;

  /// No description provided for @benefitsLableText.
  ///
  /// In en, this message translates to:
  /// **'Track your performance and earnings'**
  String get benefitsLableText;

  /// No description provided for @earningsLableText.
  ///
  /// In en, this message translates to:
  /// **'Track your earnings and payouts'**
  String get earningsLableText;

  /// No description provided for @historyLableText.
  ///
  /// In en, this message translates to:
  /// **'View your past trips and details'**
  String get historyLableText;

  /// No description provided for @rewardsLableText.
  ///
  /// In en, this message translates to:
  /// **'Achieve milestones and earn rewards'**
  String get rewardsLableText;

  /// No description provided for @incentivesLableText.
  ///
  /// In en, this message translates to:
  /// **'Earn extra for targets completed'**
  String get incentivesLableText;

  /// No description provided for @levelUpLableText.
  ///
  /// In en, this message translates to:
  /// **'Level up your profile status'**
  String get levelUpLableText;

  /// No description provided for @referralLableText.
  ///
  /// In en, this message translates to:
  /// **'Invite friends and earn together'**
  String get referralLableText;

  /// No description provided for @preferencesLableText.
  ///
  /// In en, this message translates to:
  /// **'Customize your app experience'**
  String get preferencesLableText;

  /// No description provided for @subscriptionLableText.
  ///
  /// In en, this message translates to:
  /// **'Manage your active subscription plan'**
  String get subscriptionLableText;

  /// No description provided for @notificationLableText.
  ///
  /// In en, this message translates to:
  /// **'View updates and notifications'**
  String get notificationLableText;

  /// No description provided for @languagesLableText.
  ///
  /// In en, this message translates to:
  /// **'Change your preferred language'**
  String get languagesLableText;

  /// No description provided for @myRouteBookingLableText.
  ///
  /// In en, this message translates to:
  /// **'Set your target route details'**
  String get myRouteBookingLableText;

  /// No description provided for @sosLableText.
  ///
  /// In en, this message translates to:
  /// **'Manage emergency contacts and alerts'**
  String get sosLableText;

  /// No description provided for @appSettingsLableText.
  ///
  /// In en, this message translates to:
  /// **'App settings and logout'**
  String get appSettingsLableText;

  /// No description provided for @settingsLableText.
  ///
  /// In en, this message translates to:
  /// **'Manage app configuration'**
  String get settingsLableText;

  /// No description provided for @logoutLableText.
  ///
  /// In en, this message translates to:
  /// **'Sign out of your account'**
  String get logoutLableText;

  /// No description provided for @enterOtpCodeText.
  ///
  /// In en, this message translates to:
  /// **'Enter the 6-digit code'**
  String get enterOtpCodeText;

  /// No description provided for @sendVerificationCodeText.
  ///
  /// In en, this message translates to:
  /// **'We\'ve sent a verification code to'**
  String get sendVerificationCodeText;

  /// No description provided for @codeValidText.
  ///
  /// In en, this message translates to:
  /// **'Your code is valid for '**
  String get codeValidText;

  /// No description provided for @codeValidTimeText.
  ///
  /// In en, this message translates to:
  /// **'5 minutes'**
  String get codeValidTimeText;

  /// No description provided for @otpPageEncryptedText.
  ///
  /// In en, this message translates to:
  /// **'Your information is secure and encrypted'**
  String get otpPageEncryptedText;

  /// No description provided for @loginOwnerConnectText.
  ///
  /// In en, this message translates to:
  /// **'Owner Connect'**
  String get loginOwnerConnectText;

  /// No description provided for @loginWelcomeBackText.
  ///
  /// In en, this message translates to:
  /// **'Welcome Back!'**
  String get loginWelcomeBackText;

  /// No description provided for @loginToContinueText.
  ///
  /// In en, this message translates to:
  /// **'Login to continue'**
  String get loginToContinueText;

  /// No description provided for @logincontinueWithOthersText.
  ///
  /// In en, this message translates to:
  /// **'or continue with'**
  String get logincontinueWithOthersText;

  /// No description provided for @loginVerifyText.
  ///
  /// In en, this message translates to:
  /// **'VERIFY'**
  String get loginVerifyText;

  /// No description provided for @signupCreateAccountText.
  ///
  /// In en, this message translates to:
  /// **'Create your account'**
  String get signupCreateAccountText;

  /// No description provided for @signupCreateAccountSubText.
  ///
  /// In en, this message translates to:
  /// **'Let\'s get you all set up.'**
  String get signupCreateAccountSubText;

  /// No description provided for @signupEmailAddressOptional.
  ///
  /// In en, this message translates to:
  /// **'Email Address (Optional)'**
  String get signupEmailAddressOptional;

  /// No description provided for @signupEmailAddressText.
  ///
  /// In en, this message translates to:
  /// **'Email Address'**
  String get signupEmailAddressText;

  /// No description provided for @signupEnterYourFullName.
  ///
  /// In en, this message translates to:
  /// **'Enter your full name'**
  String get signupEnterYourFullName;

  /// No description provided for @signupPasswordSendMobileText.
  ///
  /// In en, this message translates to:
  /// **'We\'ll send a one-time password (OTP) to this number to confirm your identity.'**
  String get signupPasswordSendMobileText;

  /// No description provided for @signupPasswordSendEmailText.
  ///
  /// In en, this message translates to:
  /// **'We\'ll send a one-time password (OTP) to this email to confirm your identity.'**
  String get signupPasswordSendEmailText;

  /// No description provided for @signupContinuingAgreementText.
  ///
  /// In en, this message translates to:
  /// **'By continuing, you agree to our '**
  String get signupContinuingAgreementText;

  /// No description provided for @signupAndText.
  ///
  /// In en, this message translates to:
  /// **' and '**
  String get signupAndText;
  ...
  /// No description provided for @createNewPasswordSubText.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @passwordCharactersLengthText.
  ///
  /// In en, this message translates to:
  /// **'Password must be at least 8 characters'**
  String get passwordCharactersLengthText;

  /// No description provided for @changePasswordCapsText.
  ///
  /// In en, this message translates to:
  /// **'CHANGE PASSWORD'**
  String get changePasswordCapsText;

  /// No description provided for @changePasswordLowerText.
  ///
  /// In en, this message translates to:
  /// **'Change Password'**
  String get changePasswordLowerText;

  /// No description provided for @enterYourNewPasswordText.
  ///
  /// In en, this message translates to:
  /// **'Enter your new password'**
  String get enterYourNewPasswordText;

  /// No description provided for @vehicleInfoSubText.
  ///
  /// In en, this message translates to:
  /// **'All your documents are verified and up to date.'**
  String get vehicleInfoSubText;

  /// No description provided for @documentSecureAndEncryptedText.
  ///
  /// In en, this message translates to:
  /// **'Your document is securely stored and encrypted'**
  String get documentSecureAndEncryptedText;

  /// No description provided for @neverShareYourInfoText.
  ///
  /// In en, this message translates to:
  /// **'We never share your information with anyone'**
  String get neverShareYourInfoText;

  /// No description provided for @editDocumentFrontText.
  ///
  /// In en, this message translates to:
  /// **'111 Front'**
  String get editDocumentFrontText;

  /// No description provided for @editDocumentImageText.
  ///
  /// In en, this message translates to:
  /// **'111 Image'**
  String get editDocumentImageText;

  /// No description provided for @editDocumentBackText.
  ///
  /// In en, this message translates to:
  /// **'111 Back'**
  String get editDocumentBackText;

  /// No description provided for @diagnoticsSubText.
  ///
  /// In en, this message translates to:
  /// **'Run quick checks to make sure everything is working as it should.'**
  String get diagnoticsSubText;

  /// No description provided for @homeAlertText.
  ///
  /// In en, this message translates to:
  /// **'Alert'**
  String get homeAlertText;

  /// No description provided for @biddingRidePageSubText.
  ///
  /// In en, this message translates to:
  /// **'Find and bid on rides that match your preferred distance'**
  String get biddingRidePageSubText;

  /// No description provided for @chooseMaxDistanceText.
  ///
  /// In en, this message translates to:
  /// **'Choose the max distance you want to see rides for'**
  String get chooseMaxDistanceText;

  /// No description provided for @biddingNotifyNewRideRequestAvailbleText.
  ///
  /// In en, this message translates to:
  /// **'We\'ll notify you when new ride requests are available.'**
  String get biddingNotifyNewRideRequestAvailbleText;

  /// No description provided for @biddingAdjustingDistanceSeeMoreRidesText.
  ///
  /// In en, this message translates to:
  /// **'Try adjusting the distance to see more ride requests.'**
  String get biddingAdjustingDistanceSeeMoreRidesText;

  /// No description provided for @onrideCancelReasonText.
  ///
  /// In en, this message translates to:
  /// **'Cancel Reason'**
  String get onrideCancelReasonText;

  /// No description provided for @onrideOtherReasonOptionalText.
  ///
  /// In en, this message translates to:
  /// **'Other Reason (Optional)'**
  String get onrideOtherReasonOptionalText;

  /// No description provided for @onrideOtherReasonOptionalSubText.
  ///
  /// In en, this message translates to:
  /// **'Please tell us the reason (optional)'**
  String get onrideOtherReasonOptionalSubText;

  /// No description provided for @onrideCancelDeliveryText.
  ///
  /// In en, this message translates to:
  /// **'Cancel Delivery'**
  String get onrideCancelDeliveryText;

  /// No description provided for @onrideCancelRideText.
  ///
  /// In en, this message translates to:
  /// **'Cancel Ride'**
  String get onrideCancelRideText;

  /// No description provided for @onrideWaitingTimeText.
  ///
  /// In en, this message translates to:
  /// **'Waiting Time'**
  String get onrideWaitingTimeText;

  /// No description provided for @onrideSecureAndVerifiedText.
  ///
  /// In en, this message translates to:
  /// **'Your ride is secure and verified'**
  String get onrideSecureAndVerifiedText;

  /// No description provided for @onrideUploadProofText.
  ///
  /// In en, this message translates to:
  /// **'Upload a clear image of the shipment proof'**
  String get onrideUploadProofText;

  /// No description provided for @onrideUploadProofBrowseText.
  ///
  /// In en, this message translates to:
  /// **'or tap to browse'**
  String get onrideUploadProofBrowseText;

  /// No description provided for @onrideDataSafeText.
  ///
  /// In en, this message translates to:
  /// **'Your data is safe'**
  String get onrideDataSafeText;

  /// No description provided for @onrideDocumentEncryptedText.
  ///
  /// In en, this message translates to:
  /// **'Your documents are encrypted and stored securely.'**
  String get onrideDocumentEncryptedText;

  /// No description provided for @onrideSignatureSubText.
  ///
  /// In en, this message translates to:
  /// **'Please sign in the box using your finger. Make sure it\'s clearly visible.'**
  String get onrideSignatureSubText;

  /// No description provided for @signHereText.
  ///
  /// In en, this message translates to:
  /// **'Sign here'**
  String get signHereText;

  /// No description provided for @signatureSecureText.
  ///
  /// In en, this message translates to:
  /// **'Your signature is secure'**
  String get signatureSecureText;

  /// No description provided for @signatireConfirmText.
  ///
  /// In en, this message translates to:
  /// **'This signature will be used to verify the delivery and confirm acceptance.'**
  String get signatireConfirmText;

  /// No description provided for @onrideUploadShipmentProofText.
  ///
  /// In en, this message translates to:
  /// **'Upload a clear image of the proof to verify the delivery.'**
  String get onrideUploadShipmentProofText;

  /// No description provided for @tipsForGoodPhotosText.
  ///
  /// In en, this message translates to:
  /// **'Tips for a good photo'**
  String get tipsForGoodPhotosText;

  /// No description provided for @tipsForGoodPhotosTitleTextOne.
  ///
  /// In en, this message translates to:
  /// **'Good Lighting'**
  String get tipsForGoodPhotosTitleTextOne;

  /// No description provided for @tipsForGoodPhotosSubTextOne.
  ///
  /// In en, this message translates to:
  /// **'Ensure the image is well-lit and clear.'**
  String get tipsForGoodPhotosSubTextOne;

  /// No description provided for @tipsForGoodPhotosTitleTextTwo.
  ///
  /// In en, this message translates to:
  /// **'All Details Visible'**
  String get tipsForGoodPhotosTitleTextTwo;

  /// No description provided for @tipsForGoodPhotosSubTextTwo.
  ///
  /// In en, this message translates to:
  /// **'Make sure all important details are visible.'**
  String get tipsForGoodPhotosSubTextTwo;

  /// No description provided for @tipsForGoodPhotosTitleTextThree.
  ///
  /// In en, this message translates to:
  /// **'No Blurry Images'**
  String get tipsForGoodPhotosTitleTextThree;

  /// No description provided for @tipsForGoodPhotosSubTextThree.
  ///
  /// In en, this message translates to:
  /// **'Avoid blurry or cropped images.'**
  String get tipsForGoodPhotosSubTextThree;

  /// No description provided for @completeMoreRidesText.
  ///
  /// In en, this message translates to:
  /// **'Complete more rides'**
  String get completeMoreRidesText;

  /// No description provided for @increaseYourEarningsText.
  ///
  /// In en, this message translates to:
  /// **'to increase your earnings'**
  String get increaseYourEarningsText;

  /// No description provided for @failedToLoadRidesText.
  ///
  /// In en, this message translates to:
  /// **'Failed to load rides'**
  String get failedToLoadRidesText;

  /// No description provided for @noAcceptedRidesText.
  ///
  /// In en, this message translates to:
  /// **'No accepted rides'**
  String get noAcceptedRidesText;

  /// No description provided for @browseAndAcceptOutstationRideText.
  ///
  /// In en, this message translates to:
  /// **'Browse and accept outstation ride requests'**
  String get browseAndAcceptOutstationRideText;

  /// No description provided for @notifyNewOutstationRequestAvailableText.
  ///
  /// In en, this message translates to:
  /// **'We\'ll notify you when new outstation requests are available.'**
  String get notifyNewOutstationRequestAvailableText;

  /// No description provided for @acceptOutstationRidesEarlyText.
  ///
  /// In en, this message translates to:
  /// **'Accept outstation rides early for better earnings.'**
  String get acceptOutstationRidesEarlyText;

  /// No description provided for @instantActivitySubText.
  ///
  /// In en, this message translates to:
  /// **'Manage your activities and preferences'**
  String get instantActivitySubText;

  /// No description provided for @instantRideSubText.
  ///
  /// In en, this message translates to:
  /// **'Book a ride instantly'**
  String get instantRideSubText;

  /// No description provided for @helpCenterSubText.
  ///
  /// In en, this message translates to:
  /// **'Get support and assistance'**
  String get helpCenterSubText;

  /// No description provided for @showBubbleIconSubText.
  ///
  /// In en, this message translates to:
  /// **'Show app over other apps'**
  String get showBubbleIconSubText;

  /// No description provided for @myServicesSubText.
  ///
  /// In en, this message translates to:
  /// **'View and manage services'**
  String get myServicesSubText;

  /// No description provided for @notGettingRequestSubText.
  ///
  /// In en, this message translates to:
  /// **'Trounleshoot and solutions'**
  String get notGettingRequestSubText;

  /// No description provided for @preferencesSubText.
  ///
  /// In en, this message translates to:
  /// **'Manage app preferences'**
  String get preferencesSubText;

  /// No description provided for @invoiceNoDataSubText.
  ///
  /// In en, this message translates to:
  /// **'No active trip summary data found.'**
  String get invoiceNoDataSubText;

  /// No description provided for @invoiceRequestIdCopiedText.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @chooseLanguageSubText.
  ///
  /// In en, this message translates to:
