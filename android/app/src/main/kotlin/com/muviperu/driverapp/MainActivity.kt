package com.muviperu.driverapp

import com.muviperu.driverapp.ChatHeadService
...
class MainActivity : FlutterFragmentActivity() {
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        channel = MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "com.muviperu.driverapp")
